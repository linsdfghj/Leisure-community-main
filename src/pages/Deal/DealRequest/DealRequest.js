...
import "./DealRequest.css"
import avatar from '../../../assets/images/pictures/bozai.png'
                            ...
                            <div className="root-reply-avatar">
                                ...
                                <div className="reply-box-avatar">
                                    <div className="bili-avatar">
                                        <img className="bili-avatar-img" src={require("../../../assets/images/pictures/Rectangle 01.jpg")} alt="用户头像" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="root-reply">
                                    ...
                                    <div className="reply-img">
                                        <img className='replyImg'
                                            src={require("../../../assets/images/pictures/Rectangle 80.png")}></img>
                                    </div>
